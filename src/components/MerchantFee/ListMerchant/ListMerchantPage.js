...
class ListMerchantPage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      currentPage: 1,
  ...
  componentDidMount() {
    ...
    const { loadTableDefault, isSuccessInEditMerchantReducer, dataSearch } = this.props;
    if (!dataSearch) {
...
export default connect(mapStateToProps, mapDispatchToProps)(ListMerchantPage);
