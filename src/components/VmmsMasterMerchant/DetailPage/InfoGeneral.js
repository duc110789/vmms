                              ...
                              <div className="col-md-6">
                                ...
                                <div className="form-group">
                                  <div className="col-md-6">
                                    ...
                                    <div className="form-group row">
                                      <Label className="col-sm-6 control-label p_top">Người chỉnh sửa</Label>
                                      <div className="col-sm-6">
                                        <Label>
                                          <b>
                                            {dataObject && dataObject.createUser}
                                  ...
                                  <div className="col-md-6">
                                    ...
                                    <div className="form-group row">
                                      <Label className="col-sm-8 control-label p_top">Thời gian mở khóa</Label>
                                    ...
                                    <div className="form-group row">
                                      <Label className="col-sm-8 control-label p_top">Thời gian chỉnh sửa</Label>
                                      <div className="col-sm-4">
                                        <Label>
                                          <b>
                                            22/09/2018 09:00:00
