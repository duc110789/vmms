...
class FillMerchant extends Component {
  ...
  componentDidMount() {
    const {
      loadFeeNameMerchant, loadTypeSource, loadTypeChannel, loadMerchantStatus,
    } = this.props;
    loadFeeNameMerchant();
    loadTypeSource();
    loadTypeChannel();
  ...
  static getDerivedStateFromProps(props, state) {
    const {
      feeName, typeSource, payChannel, arrayMerchantName, status,
    } = props;
  ...
  render() {
    const {
      isClearable,
      feeName, typeSource, payChannel, arrayMerchant, merchantCode, arrayMerchantStatus, errorTime, merchantCodeLabel,
    } = this.state;
      ...
      <Row>
        <Col md="4">
          <FormGroup row>
            <Col lg="5" className="label-left">
              <Label htmlFor="code">Mã phí - Tên mức phí:</Label>
            </Col>
            <Col lg="7">
              <Select
          ...
          <FormGroup row>
            <Col lg="5" className="label-left">
              <Label htmlFor="code">Hình thức thanh toán:</Label>
            </Col>
            <Col lg="7">
              <Select
        ...
        <Col md="4">
          ...
          <FormGroup row>
            ...
            <Col lg="5" className="label-left">
              <Label htmlFor="code">MID - Tên Merchant</Label>
            </Col>
            <Col lg="7">
              <Select
